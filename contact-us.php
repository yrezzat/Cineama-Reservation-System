...
<body>
<?php 
        $link = mysqli_connect("localhost", "root", "mysql", "cinema_db");
?>
    <header></header>
    ...
    <div class="contact-us-container">
        <div class="contact-us-section contact-us-section1">
            <h1>Contact</h1>
            <p>Ad pri duis quidam equidem. Ea vix quas denique delicata, at mel possit erroribus, illud mucius ei vim. Sea blandit pertinacia ea, idque minimum antiopam ea eos, alii concludaturque ea mea.</p>
