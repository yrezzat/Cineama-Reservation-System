...
<body>
    ...
    <div class="admin-container">
        <div class="admin-section admin-section1 ">
            <ul>
                <li><i class="fas fa-sliders-h"></i>Dashboard <i class="fas admin-dropdown fa-chevron-right"></i></li>
                <li><i class="fas fa-ticket-alt"></i>Bookings <i class="fas admin-dropdown fa-chevron-right"></i></li>
